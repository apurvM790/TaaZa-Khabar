...
const Technology = ()=>{
    // const Api = "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=7b72a73685e044f4a0da0bceec6e8db9";

    const { countryCode } = useContext(codeContext);

    const Api = NEWS_API + (countryCode===""?"language=en":"country="+countryCode)+"&category=technology"+ API_KEY;
    console.log(Api);
